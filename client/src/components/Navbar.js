      ...
      <div className="container">
        <div className="flex items-center justify-between">
          <div className="logo-box">
            <h1 className="text-xl font-bold font-railway ">
          ...
          <div className="lg:block hidden z-50">
            <menu className="flex items-center justify-between gap-10 ">
              <li className="text-sm font-bold text-gray-900 uppercase     p-2 px-3 hover:bg-primary hover:text-gray-50 transition duration-500	">
                Home
              </li>
              <li className="text-sm font-bold text-gray-900 uppercase       p-2 px-3 hover:bg-primary hover:text-gray-50 transition duration-500">
                Plans
